...
- מעבר בין מצב מלא למצב קישורים בלבד
...
- `/mode` פותח בורר מצב פלט ומציג מה המצב הנוכחי
- `/only_links_mode` מחליף ישירות למצב שבו מתקבלים רק לינקים, עם שורה ריקה ביניהם
- `/full_mode` מחזיר ישירות לפורמט המלא עם כותרות וטקסט
